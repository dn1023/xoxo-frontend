...
const ContactComponent = () => {
    const apiKey = '879ec6751b4440cc4a12a1045ed552c7'
    const apiSecret = 'e9beeff2ab040e57695dd985defd369b'
            ...
            Messages: [
              {
                ...
                To: [
                  {
                    Email: 'dreamsky0701@hotmail.com',
                  },
                ],
                ...
                Subject: 'Mail from Client via Portfolio',
                HTMLPart: values.message,
                TextPart: values.message,
              },
            ],
          };
