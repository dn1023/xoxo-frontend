          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-3/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-md bg-white dark:shadow-none">
                <div className="flex items-center justify-left border-b border-body-color border-opacity-10 px-8 py-8">
                ...
                <ul className="p-8">
                  <li className="mb-6 pb-6 flex items-center justify-left">
                  ...
                  <li className="mb-6 pb-6 flex items-center justify-left">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M560-680v-80h320v80H560Zm0 160v-80h320v80H560Zm0 160v-80h320v80H560Zm-240-40q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM80-160v-76q0-21 10-40t28-30q45-27 95.5-40.5T320-360q56 0 106.5 13.5T522-306q18 11 28 30t10 40v76H80Zm86-80h308q-35-20-74-30t-80-10q-41 0-80 10t-74 30Zm154-240q17 0 28.5-11.5T360-520q0-17-11.5-28.5T320-560q-17 0-28.5 11.5T280-520q0 17 11.5 28.5T320-480Zm0-40Zm0 280Z" /></svg>
                    <button
                  ...
                  <li className="mb-6 pb-6 flex items-center justify-left">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M200-640h560v-80H200v80Zm0 0v-80 80Zm0 560q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v227q-19-9-39-15t-41-9v-43H200v400h252q7 22 16.5 42T491-80H200Zm520 40q-83 0-141.5-58.5T520-240q0-83 58.5-141.5T720-440q83 0 141.5 58.5T920-240q0 83-58.5 141.5T720-40Zm67-105 28-28-75-75v-112h-40v128l87 87Z" /></svg>
                    <button
            ...
            <div className="w-full px-4 lg:w-9/12">
              ...
              <div className={`${pageIndex === 2 ? "block" : "hidden"}`}><EmployeeManagement /></div>
              <div className={`${pageIndex === 3 ? "block" : "hidden"}`}><OrderManagement /></div>
